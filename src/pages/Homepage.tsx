        ...
        <div className="container-fluid homepage">
            ...
            <div className="col">
              <div className="cards-homepage">
                <HomepageCard
                  ...
                  title={
                    language === 'mk'
                      ? "Уникатенo Рачно Изработен Накит"
                ...
                <HomepageCard
                  ...
                  title={
                    language === 'mk'
                      ? "Исклучителен Домашен Декор"
                      : "Exceptional Home Decor"
                  }
          ...
          <div className="row bg-butterfly">
            <div className="col">
              <h1>
                {language === 'mk'
                  ? "Секогаш уникатно, никогаш точно исто!"
                  : "Always unique, never exactly the same!"}
              </h1>
              <p>
                {language === 'mk'
          ...
          <div className="row">
            ...
            <div className="col ">
              <div>
                ...
                <button className="button-cs-brown">
          ...
          <div className="row bg-butterfly">
            <div className="col">
              ...
              <button className="button-cs-brown">
                {language === 'mk' ? "Контакт Детали" : "Contact Details"}
              </button>
            </div>
          </div>
          <div className="row my-5">
            <div className="col ">
              ...
              <img
                className="py-5"
                style={{ width: 40, margin: 'auto', transform: 'rotate(180deg)' }}
                src="../../public/images/Home-Page/leaf_divider.svg"
                alt=""
              />
              <Testimonial
